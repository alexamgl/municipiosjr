...
<head>
    ...
    <title>Secretaría Particular</title>
    <style>
...
<div class="container mt-4">
    <h1 class="text-center" style="font-weight: 900; color: #0b3b59;">Secretaría Particular</h1>
        ...
        <div class="col-md-12">
            <div class="card custom-card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Organizar las actividades particulares de la persona titular de la Presidencia Municipal y sus
                        relaciones particulares, coordinando la agenda particular con las actividades de la Administración
                        Pública, llevando con eficiencia y eficacia la agenda del Presidente Municipal, dando atención al
                        seguimiento a la correspondencia oficial y de la ciudadanía, al igual que recibir, canalizar y concluir el
                        seguimiento a las peticiones, quejas y denuncias que se presentan por medio del Módulo de Atención
                        Ciudadana.</p>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Secretaría Particular</h5>
                    <p class="card-text"><strong>Dirección:</strong> Av. Paso de los Guzmán, No. 24, Barrio de la Concepción</p>
                    <p class="card-text"><strong>Contacto:</strong> (427) 689 0012 Ext. 107</p>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalMap1">Ver en Google Maps</button>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <img src="/images/dependencias/SEC PARTICULAR.png" alt="Descripción de la imagen" class="img-card">
        </div>
        <h1 class="text-center" style="font-weight: 900; color: #0b3b59;">Áreas</h1>
        <div class="col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Dirección de atención ciudadana</h5>
                    <button class="btn btn-primary btn-circle" onclick="toggleContent(this)">+</button>
                <div class="card-text" style="display: none;"><strong>Objetivo:</strong> Ser el contacto directo con los ciudadanos para brindar atención, seguimiento y desahogo a todas las
                        solicitudes, en todos los trámites y servicios que presta esta administración a la ciudadanía. <br> <strong>Contacto:</strong> (427) 689 0012 Ext. 101 y 102</p></div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Dirección de Relaciones Públicas</h5>
                    <button class="btn btn-primary btn-circle" onclick="toggleContent(this)">+</button>
                    <div class="card-text" style="display: none;"><strong>Objetivo:</strong> Vincular con los sectores educativo, empresarial y turístico con las autoridades de distintos niveles y
                        ciudadanía en general. <br> <strong>Contacto:</strong> (427) 689 0012 Ext. 103</p>
                    </div>
                </div>
            </div>
        </div>
...
<div style="padding: 80px;">
    ...
    $sql = "SELECT id, titulo, cuerpo, imagen, fecha_publicacion FROM noticias WHERE id_dependencia=1 ORDER BY fecha_publicacion DESC LIMIT 10";
...
<div class="modal fade" id="modalMap1" tabindex="-1" aria-labelledby="modalMap1Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalMap1Label">Secretaría Particular</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <iframe 
